    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-10">
            <div class="jumbotron how-to-create" >
                ...
                <br />
                @foreach(App\Models\Image::where('model',$model)->where('model_id',$id)->get() as $image)
                <img src="/images/icon_size/{{ $image->filename}}">
                <a href="{{ URL::Route('delete-image', $image->id) }}">sil</a>
                @endforeach
