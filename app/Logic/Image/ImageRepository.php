...
{
    public function upload( $form_data, $model, $id )
    {
        ...
        $sessionImage->model = $model;
        $sessionImage->model_id = $id;
    ...
    public function custom_delete( $filename )
    {

        $full_size_dir = Config::get('images.full_size');
        $icon_size_dir = Config::get('images.icon_size');

        $sessionImage = Image::find($filename);
